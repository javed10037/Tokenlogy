                       ...
                       <tr>
                         ...
                         <table cellspacing="0" cellpadding="0" class="force-full-width">
                           ...
                           <tr>
                             ...
                             To start rocking the cryptocurrency world, click the link below.<br/>
                             Please click on the following link, or paste into your browser to complete the verification process : <br/> <br/>
                             <a href ="`+CONST.hostingServer.serverName+verifyurl+`" target="_blank" > `+ CONST.hostingServer.serverName +`verifyurl </a><br><br>
                             <br></td>
                           </tr>
                         ...
                         <table cellspacing="0" cellpadding="0" width="100%">
                           <tr>
                             ...
                             If you did not request this, please ignore.<br><br>
                               ...
                               drop us an email at cntctspprtmarket@gmail.com. <br><br><br><br>
                               Happy trading!
                             </td>
                           </tr>
                         </table>
           ...
           <center>
             ...
             <table cellspacing="0" cellpadding="0" width="600" class="w320">
               <tr>
                 ...
                 If this was you, please click on this link to reset your password:  
                 <a href=`+ CONST.hostingServer.serverName+'en/#/updatePassword/' + token + '>' + CONST.hostingServer.serverName+`'reset-password/'` + token + `'</a><br><br>
                 <p style="font-size:17px; text-align:center;"> your account : ` + req.email + `<br> </p>
            <br><br>
                     ...
                     <table cellspacing="0" cellpadding="0" width="600" class="w320">
                      ...
                      <table cellspacing="0" cellpadding="0" width="100%" bgcolor="#ffffff" >
                        <tr>
                          ...
                          Your Query has been send succssfully to the Kryptual Team .You've successfully gone through the process of  contact at Kryptual. We will get back to you with in 2 to 3 days.<br><br><br>
                              </td>
                            </tr>
                          </table>
                          ...
                          <td style="background-color:#ffffff;">
                           ...
                           <table cellspacing="0" cellpadding="0" width="100%">
                            <tr>
                              <td style="text-align:left; font-size:13px;" class="mobile-center body-padding w320">
                              <br>
                                Thank you for subscribe at Kryptual! We keep our ICO list up to date and providing quality information about Pre ICOs, Active ICOs, Upcoming ICOs, Ended ICOs.<br>
                               You've successfully gone through the process of subscribe at Kryptual. <br>
                               You'll now get an email each time we Launch ICO. <br>
                              </td>
                            </tr>
                          </table>
